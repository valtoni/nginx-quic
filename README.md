...
This repository builds an nginx image with the QUIC/TLS patches on top of Alpine and publishes it to Docker Hub.

## Build script
- `build.ps1` downloads the latest Alpine, NGINX and quictls references (unless provided) and pushes the resulting image to `valtoni/nginx-quic`.
